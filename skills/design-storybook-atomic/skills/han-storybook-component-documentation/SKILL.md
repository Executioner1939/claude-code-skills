---
name: han-storybook-component-documentation
...
> **Source:** This skill is adapted from the [`han`](https://github.com/TheBushidoCollective/han) plugin marketplace by **The Bushido Collective**, licensed under **Apache-2.0**. Original: `storybook-component-documentation` skill in `plugins/tools/storybook/skills/storybook-component-documentation/SKILL.md`. Modifications: kept original content; added cross-references to integrated skills in this plugin (`atomic-design`, `storybook-authoring`, `storybook-atomic-integration`, `design-tokens`, `component-composition`, `accessibility-stories`, `story-coverage-checklist`) where relevant.
>
> The original skill targets Storybook 7 / 8 conventions. For modern Storybook 9 / 10 conventions (CSF Factories, `@storybook/addon-vitest`, `@storybook/addon-docs/blocks`, framework-specific packages), see this plugin's `storybook-authoring` skill.
