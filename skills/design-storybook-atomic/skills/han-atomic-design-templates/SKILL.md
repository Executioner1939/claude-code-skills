---
name: han-atomic-design-templates
...
> **Source:** This skill is adapted from the [`han`](https://github.com/TheBushidoCollective/han) plugin marketplace by **The Bushido Collective**, licensed under **Apache-2.0**. Original: `atomic-design-templates` skill in `plugins/patterns/atomic-design/skills/atomic-design-templates/SKILL.md`. Modifications: kept original content; added cross-references to integrated skills in this plugin (`atomic-design`, `storybook-authoring`, `storybook-atomic-integration`, `design-tokens`, `component-composition`, `accessibility-stories`, `story-coverage-checklist`) where relevant.
>
