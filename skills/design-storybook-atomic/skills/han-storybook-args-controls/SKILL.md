---
name: han-storybook-args-controls
...
> **Source:** This skill is adapted from the [`han`](https://github.com/TheBushidoCollective/han) plugin marketplace by **The Bushido Collective**, licensed under **Apache-2.0**. Original: `storybook-args-controls` skill in `plugins/tools/storybook/skills/storybook-args-controls/SKILL.md`. Modifications: kept original content; added cross-references to integrated skills in this plugin (`atomic-design`, `storybook-authoring`, `storybook-atomic-integration`, `design-tokens`, `component-composition`, `accessibility-stories`, `story-coverage-checklist`) where relevant.
>
