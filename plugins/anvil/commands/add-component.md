...
```text
<scope>/.anvil/handoffs/add-component-<run>/phase-00-spec-to-cartography.md
```
...
HANDOFF: `<scope>/.anvil/handoffs/add-component-<run>/phase-01-cartography-to-composer.md`.
...
HANDOFF: `<scope>/.anvil/handoffs/add-component-<run>/phase-02-decision-to-build.md`.
...
HANDOFF: `<scope>/.anvil/handoffs/add-component-<run>/phase-04a-implement-to-tokens.md`.
...
HANDOFF: `<scope>/.anvil/handoffs/add-component-<run>/phase-04b-tokens-to-stories.md`.
...
- `<scope>/.anvil/handoffs/add-component-<run>/phase-04c-stories-to-a11y.md`
- `<scope>/.anvil/handoffs/add-component-<run>/phase-04c-mdx-to-a11y.md`
...
HANDOFF: `<scope>/.anvil/handoffs/add-component-<run>/phase-04d-review-to-final.md`.
...
NEXT
  - Run /anvil:audit-<level> <Name> to grade against the rubric.
...
3. **No auto-write of component / story / MDX files before Step 4 confirmation.** The user must confirm verdict + level before any *implementation* file is written. Exception: HANDOFF.md phase artifacts under `.anvil/handoffs/` and agent-memory snapshots are allowed throughout (Steps 0–3) — these are workflow artifacts, not implementation.
...
6. **Surface dependencies.** If BUILD-NEW requires a missing token (e.g. `motion.feedback`), pause and ask whether to add the token first (run `/anvil:audit-tokens` Block 1).
...
- **Inventory finds wildly inconsistent classifications.** Recommend running `/anvil:audit-atoms` first.
