...
```text
<scope>/.anvil/handoffs/<workflow>-<run-id>/phase-<N>-<from>-to-<to>.md
```
...
- `<workflow>` — the slash command name, e.g. `audit-atoms`, `add-component`, `merge-duplicates`.
...
|---|------------------------|---------------------------|--------|------------------------------------------|
| 1 | Cartography            | component-cartographer    | ✅     | <scope>/.anvil/handoffs/<workflow>-<run-id>/phase-01-cartographer-to-auditor.md |
