...
Read `design-tokens` (the taxonomy + heuristics this audit enforces) and the project's `.design-storybook-atomic.yml`. Check baseline at `<scope>/.design-storybook-atomic/baseline-tokens.md`.
...
HANDOFF.md path: `<scope>/.design-storybook-atomic/handoffs/audit-tokens-<run>/phase-01-source-to-scan.md`.
...
HANDOFF.md path: `<scope>/.design-storybook-atomic/handoffs/audit-tokens-<run>/phase-02-scan-to-grade.md`.
...
HANDOFF.md path: `<scope>/.design-storybook-atomic/handoffs/audit-tokens-<run>/phase-03-grade-to-orchestrator.md`.
...
- Baseline: `<scope>/.design-storybook-atomic/baseline-tokens.md`
- Dated history: `<scope>/.design-storybook-atomic/history/tokens-<YYYY-MM-DD>.md`
